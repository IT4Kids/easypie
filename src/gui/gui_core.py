...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, pygame_canvas, parent=None):
        ...
        self.setWindowIcon(QtGui.QIcon(res("gui/res/icon.png")))
        self.setWindowTitle("It4Kids: EasyPie")
        self.setStyleSheet(open(res("gui/style.css")).read()) #Todo make configurable

        #Setup Toolbar
        toolbar = QtWidgets.QToolBar()
        toolbar.setIconSize(QtCore.QSize(40, 40))

        play_action = toolbar.addAction(QtGui.QIcon(res('gui/res/play.png')),
                                        "Play (F5)",
        ...
        stop_action = toolbar.addAction(QtGui.QIcon(res('gui/res/stop.png')),
                                        "Stop (F6)",
